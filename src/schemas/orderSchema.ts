...
export const orderSchema = z.object({
  ...
  patient_phone_number: z.string().nullable().optional(),
  patient_class: z.string().nullable().optional(),
  visit_number: z.string().nullable().optional(),
  accession_number: z.string(),
  placer_order_number: z.string().nullable().optional(),
  filler_order_number: z.string().nullable().optional(),
  placer_group_number: z.string().nullable().optional(),
  ...
  source: z.string(),
  source_sending_application: z.string().nullable().optional(),
  source_sending_facility: z.string().nullable().optional(),
  source_receiving_application: z.string().nullable().optional(),
  source_receiving_facility: z.string().nullable().optional(),
  source_message_control_id: z.string().nullable().optional(),
