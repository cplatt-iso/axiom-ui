// src/components/system-config/SysExternalServices.tsx
        ...
        <Card>
            <CardHeader>
                <CardTitle className="flex items-center">
                    <CogIcon className="mr-2 h-5 w-5" /> External Services
                </CardTitle>
                <CardDescription>
                    Global settings related to external service connectivity
                </CardDescription>
            </CardHeader>
            <CardContent>
