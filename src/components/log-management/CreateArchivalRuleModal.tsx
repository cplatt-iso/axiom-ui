...
interface CreateArchivalRuleModalProps {
    open: boolean;
...
export function CreateArchivalRuleModal({ open, onOpenChange }: CreateArchivalRuleModalProps) {
    ...
    const onSubmit = async (_data: ArchivalRuleForm) => {
        ...
        try {
            ...
            toast.error('Failed to create archival rule');
        } finally {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl !w-[95vw] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>Create Archival Rule</DialogTitle>
                    <DialogDescription>
                        Set up a new rule for automatically archiving logs to external storage
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid gap-4 xl:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="name"
                                    placeholder="e.g., Archive Debug Logs"
                    ...
                    <Card>
                        ...
                        <CardContent className="grid gap-4 xl:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-muted-foreground">
                                    Keep archived logs for this many days
                                </p>
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-muted-foreground">
                                    When to run the archival process
                                </p>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid gap-4 xl:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-muted-foreground">
                                    Optional prefix for archived files
                                </p>
                            </div>
