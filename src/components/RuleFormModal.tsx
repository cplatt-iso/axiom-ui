...
const createDefaultModification = (action: ModifyAction): TagModification => {
    ...
    switch (action) {
        ...
        case ModifyAction.PREPEND: case ModifyAction.SUFFIX: return { ...base, action, value: '' };
        case ModifyAction.REGEX_REPLACE: return { ...base, action, pattern: '', replacement: '' };
        default: console.warn(`Unknown modify action: ${action}, defaulting to SET.`); return { ...base, action: ModifyAction.SET, value: '', vr: '' };
    }
};
...
const RuleFormModal: React.FC<RuleFormModalProps> = ({
    ...
    const renderModificationInputs = (mod: TagModification, index: number) => {
        ...
        switch (mod.action as ModifyAction) {
            ...
            case ModifyAction.DELETE: default: return <div className="col-span-2 text-sm text-gray-500 dark:text-gray-400 italic self-center pt-2">(No value/VR needed for delete)</div>;
        }
    };
